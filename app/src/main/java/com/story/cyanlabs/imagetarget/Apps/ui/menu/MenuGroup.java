...
public class MenuGroup {
    ...
    public MenuGroup(MenuInterface menuInterface,
                     Activity context, Menu parent, boolean hasTitle, String title,
                     int width)
    {
        mActivity = context;
        ...
        mLayout = (LinearLayout) inflater.inflate(
                R.layout.sample_app_menu_group_divider, null, false);
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        //Set the listener after changing the UI state to avoid calling the radio button functionally when creating the menu
