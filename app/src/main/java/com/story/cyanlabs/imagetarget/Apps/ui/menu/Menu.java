...
public class Menu
{
    ...
    private MenuAnimator mMenuAnimator;
    private Activity mActivity;
    private MenuInterface mMenuInterface;
    private GLSurfaceView mMovableView;
    private MenuView mParentMenuView;
    private LinearLayout mMovableListView;
    private ArrayList<MenuGroup> mSettingsItems = new ArrayList<MenuGroup>();
                         ...
                         RelativeLayout parentView, ArrayList<View> additionalViewsToHide)
    {
        ...
        mParentMenuView = (MenuView) inflater.inflate(
        ...
        if (!mIsBelowICS)
            mMenuAnimator = new MenuAnimator(this);
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener()
        {
            ...
            public void onGlobalLayout()
            {
                ...
                for (MenuGroup group : mSettingsItems)
                {
    ...
    public MenuGroup addGroup(String string, boolean hasTitle)
    {
        MenuGroup newGroup = new MenuGroup(mMenuInterface,
